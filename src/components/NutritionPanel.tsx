import { feedRecords, pigNutrition, poultryNutrition } from "@/data/mockData";
import {
...
export function NutritionPanel() {
  ...
  const nutrition = tab === "pig" ? pigNutrition : poultryNutrition;
    ...
    <div className="bg-card rounded-xl border shadow-card">
      ...
      <div className="px-5 pt-5">
        ...
        <ResponsiveContainer width="100%" height={200}>
          <BarChart data={feedRecords} margin={{ top: 0, right: 8, left: -20, bottom: 0 }}>
